 ...
 *
 * <p>
 * A scope is responsible for providing a {@link Visitor} object that is used to determine which nodes are loaded when a loading
 * operation occurs. Visitors are not thread safe, as a consequence the {@link #get()} operation should create a new visitor
