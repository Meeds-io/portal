...
public abstract class BaseResourceBundleService implements ResourceBundleService, Startable {
  ...
  private final Loader<String, ResourceBundle, ResourceBundleContext>         loader_     =
                                                                                      new Loader<String, ResourceBundle, ResourceBundleContext>() {
                                                                                                                                                                                 ...
                                                                                                                                                                                 * {@inheritDoc}
                                                                                                                                                                                 */
                                                                                                                                                                                public ResourceBundle retrieve(ResourceBundleContext context,
                                                                                                                                                                                                               String key) throws Exception {
                                                                                                                                                                                  ResourceBundle resourceBundle =
                                                                                                                                                                                                                context.get(key);
                                                                                                                                                                                  return resourceBundle
                                                                                                                                                                                      == null ?
                                                                                                                                                                                              ExoResourceBundle.NULL_OBJECT :
                                                                                                                                                                                              resourceBundle;
                                                                                                                                                                                }
                                                                                                                                                                              };
  ...
  protected void initResources(String baseName, Locale locale, ClassLoader cl) {
    ...
    try {
      ...
      LOG.error("Error while reading the resource bundle : " + baseName, ex);
    }
  }
  ...
  protected String getResourceBundleContent(String baseName, Locale locale, Locale defaultLocale, ClassLoader cl)
    ...
    // fallback to en locale help to remove ant script that generates base
    // properties file
  ...
  /**
   * The class defining the context required to load a ResourceBundle from
   * classpath
   */
  ...
  /**
   * The class defining the context required to load a ResourceBundle thanks to
   * the method
  ...
  private class GetResourceBundleContext extends ResourceBundleContext {
    ...
    ResourceBundle get(String id) {
      ...
      try {
        ...
        LOG.error("Cannot load and merge the bundle: " + id, ex);
      }
