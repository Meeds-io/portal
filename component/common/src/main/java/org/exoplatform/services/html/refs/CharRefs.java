...
final class CharRefs {
    ...
    new CharRef("nbsp", '\u00a0'), // no-break space = non-breaking space, U+00A0 ISOnum
            ...
            new CharRef("laquo", '\u00ab'), // left-pointing double angle quotation mark = left pointing guillemet, U+00AB
                                            // ISOnum
            ...
            new CharRef("raquo", '\u00bb'), // right-pointing double angle quotation mark = right pointing guillemet, U+00BB
                                            // ISOnum
            ...
            new CharRef("Aring", '\u00c5'), // latin capital letter A with ring above = latin capital letter A ring, U+00C5
                                            // ISOlat1
            ...
            new CharRef("Oslash", '\u00d8'), // latin capital letter O with stroke = latin capital letter O slash, U+00D8
                                             // ISOlat1
