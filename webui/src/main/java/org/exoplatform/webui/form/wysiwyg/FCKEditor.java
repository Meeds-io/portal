...
public class FCKEditor {
     ...
     * @param width width
     * @param height height
     * @param toolbarSet toolbarSet name
     */
    public FCKEditor(final HttpServletRequest request, final String instanceName, final String width, final String height,
    ...
    public FCKEditor(final HttpServletRequest request, final String instanceName) {
        this(request, instanceName, DEFAULT_WIDTH, DEFAULT_HEIGHT, DEFAULT_TOOLBAR, null, FCKConfigListener.FCK_CONTEXT_PATH
                + "/fckeditor");
    }
    ...
    /**
     * Helper method to get the the browser version from 'userAgent' with the regular expression 'regex'. The first group of the
     * matches has to be the version number!
     *
     * @param userAgent
     * @param regex
