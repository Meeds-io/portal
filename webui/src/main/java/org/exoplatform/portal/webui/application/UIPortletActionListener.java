...
public class UIPortletActionListener {
    ...
    public void execute(Event<UIPortlet> event) throws Exception {
      ...
      if (instanceCtx.getModifiedContext() != null) {
        StatefulPortletContext<ExoPortletState> updatedCtx =
                                                           (StatefulPortletContext<ExoPortletState>) instanceCtx.getModifiedContext();
    ...
    if (state != null) {
      ...
      if (WindowState.MAXIMIZED.equals(state)) {
        if (uiPage != null) {
          ...
          PortalRequestContext.getCurrentInstance().setMaximizedUIPortlet(uiPortlet);
        }
  ...
  public static <S, C extends Serializable, I> List<javax.portlet.Event> processEvent(UIPortlet uiPortlet,
    ...
    try {
      ...
      List<javax.portlet.Event> events = new ArrayList<>(nsEvents.size());
      if (nsEvents != null && !nsEvents.isEmpty()) {
        for (UpdateNavigationalStateResponse.Event nsEvent : nsEvents) {
          javax.portlet.Event portletEvent = new PortletEvent(nsEvent.getName(), nsEvent.getPayload());
          events.add(portletEvent);
  ...
  public static class RenderActionListener extends EventListener<UIPortlet> {
    public void execute(Event<UIPortlet> event) throws Exception {
      ...
      if (navState != null) {
        uiPortlet.setNavigationalState(StateString.create(navState));
      }
    }
  }
  ...
  public static class ChangeWindowStateActionListener extends EventListener<UIPortlet> {
    public void execute(Event<UIPortlet> event) throws Exception {
      ...
      UIWorkingWorkspace uiWorkingWS = pcontext.getUIApplication().getChildById(UIPortalApplication.UI_WORKING_WS_ID);
      ...
      if (changeWindowStateAttribute instanceof String changeWindowStateAttributeString) {
        windowState = changeWindowStateAttributeString;
      }
      if (windowState == null) {
        windowState = event.getRequestContext().getRequestParameter(Constants.PORTAL_WINDOW_STATE);
      }
      if (windowState == null && event.getRequestContext().getRequestParameter(UIComponent.OBJECTID) != null) {
  ...
  public static class ChangePortletModeActionListener extends EventListener<UIPortlet> {
    public void execute(Event<UIPortlet> event) throws Exception {
      ...
      if (changePortletModeAttribute instanceof String changePortletModeAttributeString) {
        portletMode = changePortletModeAttributeString;
      }
      if (portletMode == null) {
